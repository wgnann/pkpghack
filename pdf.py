...
#
# $Id: pdf.py 374 2007-12-09 14:26:15Z jerome $
#
...
class Parser(pdlparser.PDLParser) :
    ...
    def getJobSize(self) :
        # baseado em https://gist.github.com/godber/7692812
        import subprocess
        
        pdfinfo = "/usr/bin/pdfinfo"
        output = subprocess.check_output([pdfinfo, self.infile.name])
